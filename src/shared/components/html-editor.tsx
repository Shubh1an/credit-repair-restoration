...
import {
  emailTemplateGenerateHTMLPreview,
  GetSavedSampleTemplates,
...
const HTMLEditor = (props: {
  ...
  emailTemplateGenerateHTMLPreview: any;
  hideSaveButton?: boolean;
  allowSampleDownload?: boolean;
  sampleName?: string;
  GetSavedSampleTemplates: any;
}) => {
  ...
  const downloadSampleTemplates = () => {
    ...
    props
      ?.GetSavedSampleTemplates(props?.sampleName, axiosSource)
      .then((newhtml: string) => {
...
export default connect(null, mapDispatchToProps)(HTMLEditor);
